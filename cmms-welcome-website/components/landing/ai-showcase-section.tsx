...
export function AiShowcaseSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 text-slate-900 border-b border-slate-200">
      {/* Background Glow */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-[#54EC46]/15 blur-[150px]" />
      </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 pt-2">
              {aiCapabilities.map((cap) => {
                const Icon = cap.icon;
                return (
                  <div key={cap.title} className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4 space-y-2 hover:border-emerald-500/40 hover:bg-emerald-50/30 transition-all shadow-sm">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#54EC46]/20 text-emerald-700">
            ...
            <div className="pt-2">
              <Button asChild size="lg" className="bg-[#54EC46] text-slate-950 font-bold hover:bg-[#4BD63E] shadow-md shadow-emerald-500/20 px-7">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-slate-900">FixByte AI Assistant</span>
                </div>
                <Badge className="bg-emerald-100 text-emerald-800 border-emerald-200 text-[10px] font-bold">Active Copilot</Badge>
              </div>
              ...
              <div className="space-y-3 font-sans text-xs">
                <div className="flex items-start gap-2.5 bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                  ...
                  <div className="space-y-1">
                    <p className="font-bold text-slate-900">FixByte AI Alert</p>
                    <p className="text-slate-600">
                      ⚠️ Anomaly Detected on <span className="text-emerald-700 font-bold">Boiler #03</span>. Vibration amplitude increased by 28% over 48 hours. High probability of impeller seal degradation.
                    </p>
                  </div>
                </div>

                <div className="flex items-start justify-end gap-2.5">
                  <div className="bg-blue-50 text-blue-900 p-3 rounded-xl border border-blue-200 text-right max-w-xs font-medium">
                ...
                <div className="flex items-start gap-2.5 bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                  <Bot className="h-5 w-5 text-emerald-600 shrink-0 mt-0.5" />
                  <div className="space-y-1">
                    <p className="font-bold text-emerald-700">Action Completed</p>
                    <p className="text-slate-600">
                      ✅ Work Order <span className="font-mono text-slate-900 font-bold">WO-2026-089</span> generated & assigned to Lead Technician. 2x Spare Seals <span className="font-mono text-slate-900 font-bold">SP-104</span> reserved from Main Warehouse.
                    </p>
                  </div>
                </div>
              </div>
