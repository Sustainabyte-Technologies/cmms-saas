      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-extrabold text-slate-900 sm:text-4xl lg:text-5xl">{moduleInfo.title}</h1>
          </div>
          <p className="text-slate-600 text-lg leading-relaxed">{moduleInfo.subtitle}</p>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {moduleInfo.features.map((feat: string, idx: number) => {
            ...
            return (
              <Card key={idx} className="border-slate-200 bg-slate-50/80 p-6 space-y-2 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-5 w-5 text-emerald-600" />
                  <h3 className="text-base font-bold text-slate-900">{title}</h3>
                </div>
                <p className="text-xs text-slate-600 pl-7 leading-relaxed">{desc}</p>
              </Card>
            );
          })}
        </div>
