...
class SupervisorDashboard extends StatelessWidget {
  const SupervisorDashboard({super.key, required this.data});
            ...
            child: Row(
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Hello, ${context.watch<AppState>().user?.name ?? 'Supervisor'}',
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'Monitor active tasks, track technician workloads, and assign work orders.',
                ...
                CircleAvatar(
                  ...
                  child: Icon(Icons.supervisor_account_rounded, color: scheme.primary, size: 28),
                ),
              ],
            ),
          ),
          ...
          Row(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                label: const Text('Create WO', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.assignment_ind_outlined, color: scheme.primary, size: 20),
                    ],
                  ),
                  ...
                  if (siteOrders.isEmpty)
                    const Padding(
                      ...
                      child: Center(
                        child: Text(
                          'No work orders assigned to your team.',
